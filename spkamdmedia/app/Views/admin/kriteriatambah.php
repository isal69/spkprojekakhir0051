        ...
        <section id="main-content">
            <section class="wrapper">
                    ...
                    <div class="page-breadcrumb">
                        <nav class="c_breadcrumbs">
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo base_url('kriteria/add') ?>">Tambah Data Baru</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                <div class="c_panel">
                    ...
                    <div class="c_content">
                        <form action="<?php echo base_url('kriteria/save') ?>" method="post">
                            <div class="form-group">
                                <label>Kriteria</label>
                                <input type="text" class="form-control input-sm" name="kriteria" placeholder="Nama Kriteria Lengkap" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Bobot</label>
                                <input type="number" class="form-control input-sm" min="1" max="100" name="bobot" placeholder="Bobot Kriteria" value="1">
                            </div>
                            <hr>
